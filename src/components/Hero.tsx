...
const Hero = () => {
    return (
        <div className='container mx-auto py-60 md:max-w-[1300px]'>
            <div className='flex flex-col-reverse md:flex-row lg:flex-row  xl:flex-row  justify-center md:items-center md:justify-between lg:justify-between xl:justify-between'>
                ...
                <div className='space-y-5 w-[40rem] px-7'>
                    ...
                    <div className='w-[370px] md:w-[500px]'><h2 className=' text-gray-500 '>Your Redfin account allows you enjoy zero transaction fees,
